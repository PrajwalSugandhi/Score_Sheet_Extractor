...
class TableExtractor:
    ...
    def execute(self):
        ...
        self.store_process_image("cropped_image.jpg", self.perspective_corrected_image_with_padding)
    ...
    def threshold_image(self):
        self.thresholded_image = cv2.adaptiveThreshold(self.grayscale_image, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 401, 10)

    def invert_image(self):
        self.inverted_image = cv2.bitwise_not(self.thresholded_image)

    def dilate_image(self):
        self.dilated_image = cv2.dilate(self.inverted_image, None, iterations=4)
